...
].map((s) => (Object.assign(Object.assign({}, s), { category: SPECIES_CATEGORIES.FRESHWATER })));
// --- Squid Species ---
const SQUID_SPECIES = [
    {
        id: "octopus",
...
].map((s) => (Object.assign(Object.assign({}, s), { category: SPECIES_CATEGORIES.SQUID })));
export const ALL_SPECIES = [
    ...SALTWATER_SPECIES,
    ...FRESH_WATER_SPECIES,
    ...SQUID_SPECIES,
];
export const SPECIES_BY_ID = ALL_SPECIES.reduce((acc, item) => {
    acc[item.id] = item;
    return acc;
}, {});
