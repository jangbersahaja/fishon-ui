...
export default function BookingWidget({ trips, defaultPersons = 2, personsMax, childFriendly = true, preview = false, className = "", charterId, }) {
