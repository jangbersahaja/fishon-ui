...
export const TechniqueCard = React.memo(function TechniqueCard({ techniques, className, pillSize = "md", }) {
    ...
    return (_jsxs("div", { className: "rounded-2xl border border-black/10 bg-white p-5 sm:p-6 " +
            (className || ""), children: [_jsx("h3", { className: "text-base font-semibold sm:text-lg mb-2", children: "Techniques" }), _jsx(SpeciesPills, { items: techniques.map((t) => ({ label: t })), size: pillSize, stackedNames: false, showImage: false })] }));
});
